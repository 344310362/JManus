...
docker build -t registry.cn-beijing.aliyuncs.com/exe/sm-ai-manus:prod-rj-7 -f .\Dockerfile-backend .

docker push registry.cn-beijing.aliyuncs.com/exe/sm-ai-manus:dev-rj-7
```
